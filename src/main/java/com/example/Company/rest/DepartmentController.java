...
public class DepartmentController {
    ...
    @GetMapping("/with-projects") //Test case: http://localhost:8080/departments/with-projects
    public Map<DepartmentDTO, List<ProjectDTO>> getDepartmentsWithProjects() {
        return departmentService.getDepartmentAndProjects();
    }
    @GetMapping("/departments-with-projects") //Test case: http://localhost:8080/departments/departments-with-projects
    public List<DepartmentDTO> getAllDepartmentsWithProjects() {
        return departmentService.getAllDepartmentsWithProjects();
    }
